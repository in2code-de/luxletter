...
class NavigationGroupButton extends AbstractButton
{
    ...
    protected function append(string $content): string
    {
        ...
        $content .= '<a href="https://www.in2code.de/produkte/lux-typo3-marketing-automation/" class="lux_poweredby" style="color:black; font-weight: bold;" target="_blank" rel="noopener">';
        $content .= $icon->render();
